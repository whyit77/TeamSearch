...
export const Team = ({ name, status, admin, size, description, onPress }) => (
  <TouchableOpacity onPress={onPress} style={teamListStyle.teamContainer}>
    <View style={teamListStyle.centerContainer}>
      ...
      <View style={teamListStyle.container3}>
        ...
        >
          <Text style={teamListStyle.teamLabelText} numberOfLines={1}>
            Description:
            <Text
